    ...
    <div id="invoice_print">
        ...
        <table width="100%" border="0">    
            <tr>
                ...
                <td align="right">GH₵ <?php echo $row['amount']; ?></td>
            </tr>
            <tr>
                <td align="right" width="80%"><h4><?php echo ('Paid Amount'); ?> :</h4></td>
                <td align="right"><h4>GH₵ <?php echo $row['amount_paid']; ?></h4></td>
            </tr>
            <?php if ($row['due'] != 0):?>
            <tr>
                <td align="right" width="80%"><h4><?php echo ('Due'); ?> :</h4></td>
                <td align="right"><h4>GH₵ <?php echo $row['due']; ?></h4></td>
            </tr>
            <?php endif;?>
        </table>
